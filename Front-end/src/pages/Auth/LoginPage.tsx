      ...
      >
        ...
        <div className="relative z-10 w-full max-w-md">
          ...
          <div className="rounded-2xl p-8" style={{
            ...
            <h1 className="text-2xl font-extrabold text-white text-center mb-1">Đăng nhập</h1>
            <p className="text-center text-sm mb-8" style={{ color: '#64748b' }}>Chào mừng bạn trở lại!</p>
