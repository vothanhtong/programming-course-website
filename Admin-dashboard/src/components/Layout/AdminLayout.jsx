...
import {
  ...
  UsergroupAddOutlined, SettingOutlined, MessageOutlined,
  ...
  return (
    ...
    >
      <div style={{ display: 'flex', minHeight: '100vh', background: DARK.bg }}>
        ...
        {/* ── Main area ── */}
        <div style={{ flex: 1, marginLeft: sideW, display: 'flex', flexDirection: 'column', transition: 'margin-left 0.2s', minWidth: 0 }}>
